    ...
    <div class="container-fluid">
      ...
      <div class="btn-group btn-actions">
        <button type="submit" class="btn btn-success square" title="Add New Page" onClick="document.getElementById('view').value='posts';document.myform.submit();"><i class="fa fa-plus"></i> Post</button>
      </div>
      </div>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              list($postid,$title,$body,$slug,$dateadded,$category,$photo,$status)=array_values($page);
              ?>
                <tr>
                  <td><?php echo $i++; ?></td>
