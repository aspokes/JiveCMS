...
<html lang="en">
<head>
	<title>Website Manager :: Login</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		...
		<?php } ?>
			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w"  action="index.php?action=index&pg=1" method="post" enctype="application/x-www-form-urlencoded" name="loginForm" id="loginForm" autocomplete="off">
				<?php echo (($msg))?'<div class="login-msg">'.$msg.'</div>':''; ?>
					<span class="login100-form-title p-b-32">
						Web <b>Manager</b><div class="pro">PRO</div>
					</span>
