    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb square">
        ...
        <li class="breadcrumb-item active">Likes & Comments </li>
      </ol>
      ...
      <div class="btn-group btn-actions">
        <button type="submit" class="btn btn-success square" title="Add New Page" onclick="document.getElementById('view').value='likecomments';document.myform.submit;"><i class="fa fa-plus"></i> Add Page</button>
      </div>
      </div>
      ...
      <div class="card mb-3 square">
        <div class="card-header">
          <i class="fa fa-list"></i> Likes & Comments
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              ?>
                <tr>
                  ...
                  <td>
                  <div class="btn-group">
                    <button class="btn btn-info square" type="submit" onclick="document.getElementById('keys').value='<?php echo $id;?>';document.getElementById('viewpage').value='edit';document.getElementById('view').value='likecomments';document.myform.submit();">Edit</button>
