    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3 square">
        <div class="card-header">
          <i class="fa fa-list"></i> Video Categories</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              list($id,$name,$dateadded,$status)=array_values($page);
              ?>
                <tr>
                  <td><?php echo $i++; ?></td>
                  <td><?php echo $name ?></td>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" onclick="document.getElementById('keys').value='<?php echo $id; ?>';document.getElementById('viewpage').value='updatepost';document.myform.submit;" class="btn btn-primary">Update</button>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="modal fade" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" onclick="document.getElementById('viewpage').value='saveposts';document.getElementById('view').value='';document.myform.submit;" class="btn btn-primary">Save</button>
          </div>
        </div>
      </div>
    </div>
